...
def http_function(request):
    ...
    if not HOOK_SECRET or not API_TOKEN or not WEBHOOK_URL:
...
"""
    ...
    # Send the outcome_message as a webhook to the specified URL
    payload = {
    ...
    try:
        ...
        return abort(500, f"Error sending webhook: {e}")

    return jsonify({'outcome_message': outcome_message, 'webhook_status': 'Webhook sent successfully'})